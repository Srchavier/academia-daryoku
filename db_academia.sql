...
CREATE TABLE IF NOT EXISTS `db_academia`.`tb_usuario` (
  ...
  `mat_login` VARCHAR(9) NOT NULL COMMENT 'LOGIN DO USUÁRIO PARA ACESSO AO SISTEMA',
  `mat_senha` VARCHAR(250) NOT NULL COMMENT 'SENHA DO USUÁRIO PARA ACESSO AO SISTEMA',
  `tb_pessoa_id_pessoa` INT(11) NOT NULL,
